...
class Ui_TagAdder(object):
    def setupUi(self, TagAdder):
        ...
        self.label_7.setGeometry(QtCore.QRect(50, 190, 60, 16))
        ...
        self.tag_name.setGeometry(QtCore.QRect(50, 120, 271, 22))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(40, 225, 291, 261))
        font = QtGui.QFont()
        ...
        self.save_button.setGeometry(QtCore.QRect(45, 150, 281, 32))
        self.save_button.setObjectName("save_button")
        self.newContact = QtWidgets.QLabel(TagAdder)
        self.newContact.setGeometry(QtCore.QRect(55, 55, 261, 31))
        font = QtGui.QFont()
